...
pub async fn ctx_doctor() -> anyhow::Result<serde_json::Value> {
    ...
    for tool in [
        ...
        "ctx_semantic_search", "ctx_index_embeddings", "ctx_context_pack",
        "ctx_vault_index", "ctx_vault_graph", "ctx_graph_analyze",
        "ctx_dead_code", "ctx_complexity", "ctx_dep_graph",
        "ctx_connector_list", "ctx_connector_add", "ctx_connector_sync",
        "ctx_local_index", "ctx_local_search", "ctx_local_status",
        "ctx_local_repos", "ctx_local_watch", "ctx_local_unwatch",
    ] {
